(module
 ...
 (data (i32.const 216) "\05\00\00\00b\00l\00a\00c\00k\00")
 (data (i32.const 232) "\04\00\00\00n\00o\00n\00e\00")
 (data (i32.const 248) "\0f\00\00\001\000\00p\00x\00 \00s\00a\00n\00s\00-\00s\00e\00r\00i\00f\00")
 (data (i32.const 288) "\00\00\00\00\00\00\00\00")
 (data (i32.const 296) " \01\00\00\00\00\00\00")
 ...
 (global $assembly/shared/CanvasInstruction/CanvasInstruction.SetTransform i32 (i32.const 10))
 ...
 (func $assembly/renderer/CanvasSerializerContext2D/CanvasSerializerContext2D#fillRect (; 60 ;) (type $iFFFFv) (param $0 i32) (param $1 f64) (param $2 f64) (param $3 f64) (param $4 f64)
  ...
  if
   ...
   block $assembly/renderer/CanvasSerializerContext2D/CanvasSerializerContext2D#send_string|inlined.0 (result f64)
    block $assembly/renderer/CanvasSerializerContext2D/CanvasSerializerContext2D#get:fillStyle|inlined.0 (result i32)
     get_local $0
     i32.load offset=12
     i32.load offset=12
    end
  ...
  get_local $0
  i32.load offset=92
  call $assembly/primitives/Stackable/Stackable<Matrix>#shouldUpdate
  if
